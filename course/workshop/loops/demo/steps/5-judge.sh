...
#
# From the design:
#   Decide whether a variance is a dispute, discount, duplicate, partial or typo
#
...
The question: Decide whether a variance is a dispute, discount, duplicate, partial or typo
