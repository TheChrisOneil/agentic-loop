...
#
# From the design:
#   Write the order, the history, the recomputation and the decision, then checksum it
#
# THIS STEP WRITES THE PROOF, and the design says it is checked this way:
#   SHA-256 recorded at write time and re-checked before release
#
...

{
  ...
  echo
  echo "UNIT"
  echo "  One refund request, with the order it refers to"
