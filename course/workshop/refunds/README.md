...
**One refund request, with the order it refers to**.
...
2. **The judgment step never writes a number a later step checks.** It interprets. It does not
   compute.
3. **The proof is written by code** and checksummed. SHA-256 recorded at write time and re-checked before release
