...
#
# From the design:
#   Write the diff, the grouping, the coverage result and the assessment, then checksum it
#
# THIS STEP WRITES THE PROOF, and the design says it is checked this way:
#   SHA-256 recorded at write time and re-checked before the pack is sent
#
...

{
  ...
  echo
  echo "UNIT"
  echo "  One renewal, with its changed clauses grouped by the obligation they affect"
...
echo "  8 prove: proof written and checksummed"
